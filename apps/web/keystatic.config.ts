...
export default config({
    ...
    singletons: {
        ...
        media: singleton({
            ...
            schema: {
                showSection: fields.checkbox({ label: 'Отображать блок', defaultValue: true }),
                videoUrl: fields.text({ label: 'Ссылка на видео (YouTube/Google Drive)', validation: { isRequired: false } }),
                gallery: fields.array(
                    fields.object({
                        ...
                        link: fields.text({ label: 'Ссылка при клике (на фото)', validation: { isRequired: false } }),
